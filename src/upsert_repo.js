export const upsert_repo = async (sql, repo) => {
   const { id, full_name, html_url, description, stargazers_count, archived, topics, has_issues } = repo
   ...
   const repo_size = repo.size * 1024  // repo.size is in KiB

   repo = {
      id, full_name, html_url, description, stargazers_count, archived, topics, has_issues,
      license_key,
      last_commit_date,
      owner_avatar_url,
      last_verified_at,
